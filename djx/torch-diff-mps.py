...
def main():
    ...
    worker = WorkerProc(("worker-10-%d" % 1), p_child_worker, mps_percentage=10, batch_size=8, nruns=300)
    worker.start()
    ...
    worker = WorkerProc(("worker-20-%d" % 1), p_child_worker, mps_percentage=20, batch_size=16, nruns=300)
    worker.start()
    worker_meg_list.append(p_parent_worker)
    worker_list.append(worker)
    ...
    worker = WorkerProc(("worker-30-%d" % 1), p_child_worker, mps_percentage=30, batch_size=32, nruns=300)
    worker.start()
    worker_meg_list.append(p_parent_worker)
    worker_list.append(worker)
    ...
    worker = WorkerProc(("worker-40-%d" % 1), p_child_worker, mps_percentage=40, batch_size=32, nruns=300)
    worker.start()
    worker_meg_list.append(p_parent_worker)
    worker_list.append(worker)
